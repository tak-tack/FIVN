...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
         ...
         <div class="search">
    <h1 class ="text-secondary">고객정보 수정</h1>
    <h3 class ="text-secondary">수정할 고객 정보를 입력해주세요</h3>
    
    <form action="<c:url value='/updateCustomerimpromationform.do' />" name = "form" id = "form" method="post" accept-charset="UTF-8"> 
