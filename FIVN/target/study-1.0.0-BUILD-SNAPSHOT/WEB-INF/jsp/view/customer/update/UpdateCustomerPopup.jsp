...
<body>
	...
	<div class="pop_inner">
		...
		<table id="tab04" style="padding:0px; table-layout: fixed;  height: auto; !important">	 
			 	...
			 	<tr>
					<td colspan="2"	style="height: 100px;"><div class="substance">
					${memo}
					</div></td>
				</tr>
		</table>
				...
				<button type="button" name="update_to_form" class="button button--winona button--border-thin button--round-s" >
				<span>수정</span>
				</button>
				
				<button type="button" class="button button--winona button--border-thin button--round-s" onclick="update_popup_close()">
				<span>닫기</span>
				</button>
